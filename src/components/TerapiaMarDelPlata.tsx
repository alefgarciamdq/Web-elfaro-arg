...
export default function TerapiaMarDelPlata() {
  return (
    <div className="bg-offwhite min-h-screen flex flex-col justify-center py-20 px-4 sm:px-6 lg:px-8">
      <Head>
        <title>Terapia Familiar y de Pareja en Mar del Plata · El Faro Argentina</title>
        <meta name="description" content="Terapia de pareja, abordaje vincular y terapia familiar no-residencial en Mar del Plata. El Faro Argentina." />
        <link rel="canonical" href="https://programaelfaro.com.ar/terapia-mar-del-plata" />
        <meta property="og:title" content="Terapia Familiar y de Pareja en Mar del Plata · El Faro Argentina" />
        <meta property="og:description" content="Terapia de pareja, abordaje vincular y terapia familiar no-residencial en Mar del Plata." />
      ...
      <JsonLd data={{
        ...
        "description": "Terapia de pareja, abordaje vincular y terapia familiar no-residencial en Mar del Plata."
      }} />
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a
              ...
              onClick={() => trackWhatsAppClick('placeholder_terapia', 'https://wa.me/5492235607009')}
