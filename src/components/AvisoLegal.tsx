        ...
        <div className="prose prose-lg prose-ink max-w-none font-light leading-relaxed space-y-12">
          ...
          <section>
            ...
            <ul className="list-none pl-0 space-y-2 text-ink-light">
              ...
              <li>Correo electrónico: <a href="mailto:hola@mifaro.es" className="text-olive hover:underline">hola@mifaro.es</a></li>
          ...
          <section>
            ...
            <p className="text-ink-light mb-4">
              Mi Faro es una asociación sin ánimo de lucro cuyo ámbito principal de actuación se orienta al acompañamiento, la orientación y el apoyo en procesos vinculados a la salud emocional, las adicciones y el desarrollo humano.
            </p>
          ...
          <section>
            ...
            <p className="text-ink-light">
              Todos los contenidos del sitio web, incluyendo, a título enunciativo y no limitativo, textos, imágenes, diseños, logotipos, estructura, código y demás elementos, son titularidad de Mi Faro o de terceros que han autorizado su uso, y quedan protegidos por la normativa aplicable.
            </p>
          ...
          <section>
            ...
            <div className="space-y-4 text-ink-light">
              <p>
                Mi Faro no garantiza la inexistencia de errores en el acceso al sitio web o en sus contenidos, aunque adoptará, en su caso, las medidas razonables para corregirlos.
              </p>
              <p>
                Mi Faro no se hace responsable de los daños o perjuicios que pudieran derivarse del uso de la información contenida en este sitio web ni de actuaciones realizadas sobre la base de la misma.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-ink-light">
              En caso de que este sitio web incluye enlaces a páginas de terceros, Mi Faro no asume responsabilidad sobre los contenidos, políticas o prácticas de dichos sitios externos.
            </p>
          </section>
