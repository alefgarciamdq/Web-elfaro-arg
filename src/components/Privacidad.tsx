        ...
        <div className="prose prose-lg prose-ink max-w-none font-light leading-relaxed space-y-12">
          ...
          <section>
            ...
            <ul className="list-none pl-0 space-y-2 text-ink-light">
              ...
              <li><strong className="font-medium text-ink">Correos electrónicos:</strong> <a href="mailto:hola@mifaro.es" className="text-olive hover:underline">hola@mifaro.es</a>, <a href="mailto:alefgarcia@gmail.com" className="text-olive hover:underline">alefgarcia@gmail.com</a></li>
          ...
          <section>
            ...
            <ul className="list-none pl-0 space-y-2 text-ink-light">
              <li><a href="mailto:hola@mifaro.es" className="text-olive hover:underline">hola@mifaro.es</a></li>
